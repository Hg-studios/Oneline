...
//        idEtLayout.error = "회원가이 존이재하지 않습니"
        ...
        signInBtn.setOnClickListener {
            ...
            //signIn(idEt.getText().toString(), pwEt.getText().toString())
        }
    }
...
//        nameEt.setText("")
    ...
    //https://www.programcreek.com/java-api-examples/?api=android.support.design.widget.TextInputEditText 에서 getText함수관련 ..
